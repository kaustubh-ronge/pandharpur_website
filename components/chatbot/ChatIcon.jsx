...
// //             className="absolute bg-white text-gray-800 p-2 px-4 rounded-lg shadow-md border border-gray-200 text-sm whitespace-nowrap bottom-full mb-3 right-1/2 translate-x-1/2 md:right-full md:mr-4 md:bottom-1/2 md:translate-y-1/2 md:translate-x-0 md:mb-0 /* Medium screens and up: To the left"
// //           >
...
//   return (
//     // Wrapper for initial "pop-in" animation
//     <motion.div
...
//       <motion.button
//         onClick={onClick}
//         className="p-3 text-white bg-orange-600 rounded-full shadow-lg hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-colors duration-300 ease-in-out relative z-10"
//         aria-label="Open chat"
//         // This adds the continuous pulsing animation
