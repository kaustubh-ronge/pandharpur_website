...
// //   // ... (keep your existing state and handler logic from the previous version)
...
// //     // Prevents the form from doing a page refresh
// //     event.preventDefault(); 
// //     if (!isSignedIn) return;

// //     // 1. Sanitize the phone number to remove any non-digit characters (+, -, spaces)
// //     const cleanPhoneNumber = hotel.whatsappNumber.replace(/\D/g, '');
    
// //     // 2. Create the message string. You can customize this once it's working.
// //     let message = `🛎️ *New Hotel and Lodge Booking Inquiry via PandharpurDarshan.com*\n\n`;
...
// //     // 3. URL-encode the message to make it safe for a URL
// //     const encodedMessage = encodeURIComponent(message);
    
// //     // 4. Construct the final, safe WhatsApp URL
// //     const whatsappUrl = `https://wa.me/${cleanPhoneNumber}?text=${encodedMessage}`;
    
// //     // 5. CRITICAL: Log the final URL to the browser console for debugging
// //     console.log("FINAL URL:", whatsappUrl); 

// //     // 6. Use the anchor link method to open WhatsApp reliably
...
// //     // Optional: Callback function after submission
...
// import { Calendar } from "@/components/ui/calendar";
// import { Popover, PopoverContent, PopoverTrigger } from "@/components/ui/popover";
// import { toast } from "react-hot-toast"; // Remember to install react-hot-toast
...
//       // Only run the "copy + toast" workaround for desktop users.
//       try {
//         await navigator.clipboard.writeText(message);
//         toast.success("Message copied! Paste it in WhatsApp if needed.");
//       } catch (err) {
//         console.error('Failed to copy text: ', err);
//         toast.error("Couldn't copy message. Please type your inquiry.");
//       }
//     }
