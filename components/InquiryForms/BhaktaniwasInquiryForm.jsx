...
// export function BhaktaniwasInquiryForm({ bhaktaniwas, onFormSubmit }) {
...
//     let message = `🏠 *New Bhaktaniwas Inquiry via PandharpurDarshan.com*\n\n`;
//     message += `Hello, I saw the details for *${bhaktaniwas.name}* on the Pandharpur Darshan website (pandharpurdarshan.com) and would like to inquire about the following:\n\n`;
...
//     // 4. Construct the final, universal WhatsApp URL
//     const whatsappUrl = `https://wa.me/${cleanPhoneNumber}?text=${encodedMessage}`;
    
//     // 5. Use the anchor link method to open WhatsApp reliably
...
//       name,
//       phone,
//       bhaktaniwasSlug: bhaktaniwas.slug, // Adapted for bhaktaniwas
//       entityType: 'bhaktaniwas'          // Adapted for bhaktaniwas
//     }).then(result => {
//       if (!result.success) {
