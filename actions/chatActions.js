...
// // /**
// //  * Gets the most recent chat session for a user/guest, or creates a new one.
// //  * @param {string | null} guestId - The unique ID for a non-logged-in user.
// //  * @returns {Promise<{success: boolean, session?: object, messages?: object[], error?: string}>}
// //  */
...
// // /**
// //  * Saves a user message, gets a response from Gemini, saves it, and returns the AI message.
// //  * @param {string} sessionId - The ID of the chat session.
// //  * @param {string} userMessage - The user's message content.
// //  * @returns {Promise<{success: boolean, aiMessage?: object, error?: string}>}
// //  */
...
// //     const chatHistoryForAPI = fullHistoryRaw.map(msg => ({
// //         role: msg.role,
...
//  * @param {string} sessionId - The ID of the chat session.
//  * @param {string} userMessage - The user's message content.
//  * @param {string} language - The selected language for the conversation.
//  * @returns {Promise<{success: boolean, aiMessage?: object, error?: string}>}
//  */
// // MODIFICATION: Added 'language' parameter
...
//     // MODIFICATION: Prepend a system instruction with the chosen language
//     const languageInstruction = {
//         role: 'user', // Using 'user' role for system-like instructions in Gemini history
