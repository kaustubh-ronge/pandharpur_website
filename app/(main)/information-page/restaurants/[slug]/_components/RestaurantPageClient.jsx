...
import {
    ...
    ChevronLeft, ChevronRightIcon, Clock, Globe, Star, Users, Wifi, Car, Coffee, Home
} from "lucide-react";
...
function Breadcrumbs({ restaurantName }) {
    return (
        <nav className="flex items-center text-sm font-medium text-stone-500 mb-6">
            ...
            <Link href="/information-page/restaurants" className="hover:text-orange-600 transition-colors">Restaurants</Link>
            <ChevronRight className="h-4 w-4 mx-1.5" />
