          ...
          {hotel.whatsappNumber ? (
            ...
            <InquiryDrawer type="hotel" data={hotel}>
              <DialogTrigger asChild>
                <Button
                  className="flex-1 h-12 flex items-center justify-center gap-2 text-base font-semibold bg-green-600 hover:bg-green-700 text-white transition-all duration-300 shadow-lg shadow-green-500/30"
                >
            ...
            <Button
              disabled
              variant="outline"
              className="flex-1 h-12 flex items-center justify-center gap-2 text-base font-semibold border-gray-300 text-gray-500 cursor-not-allowed transition-all duration-300 bg-gray-100"
            >
              Booking Unavailable
            </Button>
          )}
