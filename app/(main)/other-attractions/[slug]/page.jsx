...
// //  *
// //  * This component fetches and displays the detailed information
// //  * for a single attraction, with a specific two-column layout.
// //  */
...
// //           <p className="text-base font-semibold text-orange-600 tracking-wide uppercase">
// //             {attraction.category}
// //           </p>
...
// //                   loop: true,
// //                 }}
// //                 // Add the autoplay plugin if you installed it for shadcn/ui carousel
...
// //                         <CardContent className="flex aspect-video items-center justify-center p-0 h-[284px]">
// //                           <img
// //                             src={image.imageUrl}
// //                             alt={image.alt}
...
// //                 {/* Custom styling for dots is typically done with CSS.
// //                     You can add a `carousel-dots` class to the Carousel component
// //                     and style it in your global CSS file.
// //                     Example in global.css:
// //                     .carousel-dots .react-multi-carousel-dot--active button { background-color: orange !important; }
// //                 */}
// //               </Carousel>
// //             </div>
...
// //             {/* Bottom Right: Map */}
// //             <div className="flex-1 h-1/2">
// //               {attraction.location?.googleMapsUrl ? (
// //                 <iframe
// //                   src={attraction.location.googleMapsUrl}
// //                   width="100%"
// //                   height="100%"
// //                   style={{ border: 0 }}
// //                   allowFullScreen=""
...
// //                 ></iframe>
// //               ) : (
// //                 <div className="w-full h-full flex items-center justify-center bg-gray-100 rounded-lg shadow-2xl">
...
// //         {/* --- DESCRIPTION SECTION --- */}
// //         <div className="mt-16">
// //           <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center lg:text-left">About the Place</h2>
...
//                       <a 
//                         href={attraction.location.googleMapsUrl} 
//                         target="_blank" 
