...
// FILE: app/(main)/pandharpur-bookings/hotels/[slug]/_components/HotelPageClient.jsx
"use client";
...
function Breadcrumbs({ hotelName }) {
    return (
        <nav className="flex items-center text-sm font-medium text-stone-500 mb-6">
            ...
            <Link href="/pandharpur-bookings/hotels" className="hover:text-orange-600 transition-colors">Hotels</Link>
            <ChevronRight className="h-4 w-4 mx-1.5" />
