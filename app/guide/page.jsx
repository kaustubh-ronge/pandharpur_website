...
<Button variant="outline" onClick={optimizeRoute} disabled={routeOptimized} className="border-indigo-300 text-indigo-600 hover:bg-indigo-50" >
<Route className="h-4 w-4 mr-2" />
{routeOptimized ? 'Route Optimized' : 'Optimize Route'}
</Button>
)}
