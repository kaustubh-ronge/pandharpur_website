    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        >
          ...
          {!userId ? (
            <div className="bg-white/90 p-4 rounded-lg border border-amber-200">
              <p className="text-amber-800 mb-3">Sign in to save your itinerary</p>
              <Button 
                      ...
                      <div className="text-center py-12">
                        ...
                        <div className="flex gap-3 justify-center">
                          {userId ? (
                            ...
                            <div className="bg-white/90 p-4 rounded-lg border border-amber-200">
                              <p className="text-amber-800 mb-3">Sign in to plan your trip</p>
                              <Button 
                                onClick={() => window.location.href = '/sign-in'} 
                                className="bg-amber-600 hover:bg-amber-700"
                              >
